//
//  StudentBoardDetailViewController.swift
//  gthockey-iOS
//
...
class StudentBoardDetailViewController: GTHDetailViewController {
    ...
    public func set(with boardMember: BoardMember) {
        ...
        bodyTextView.setText(with: boardMember.description)
        emailButton.setTitle("Email \(boardMember.firstName)", for: .normal)
    }
