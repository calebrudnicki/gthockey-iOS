...
class NewsCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    private var newsDetailViewController = NewsDetailViewController()
...
extension NewsCollectionViewController: NewsCollectionViewCellDelegate {
    
    func didEndCellAnimation() {
        present(newsDetailViewController, animated: true, completion: nil)
    }
