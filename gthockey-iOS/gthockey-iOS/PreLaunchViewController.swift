...
class PreLaunchViewController: UIViewController {
    ...
    private let revealingSplashView = RevealingSplashView(iconImage: UIImage(named: "HeritageTLogo")!, iconInitialSize: CGSize(width: 124.0, height: 124.0), backgroundColor: .techCream)
